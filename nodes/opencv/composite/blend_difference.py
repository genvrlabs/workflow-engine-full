...
metadata = {
    "display_name": "Blend Difference",
    "description": "Difference blend mode: absolute difference |A-B|, mixed by opacity.",
    "category": "composite",
    "color": "blue",
}
...
async def execute(uid: str, token: str, inputs: dict) -> dict:
    ...
    result = cv2.addWeighted(a, 1.0 - opacity, diff, opacity, 0)
