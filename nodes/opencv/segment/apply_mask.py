"""Apply mask to image with optional inversion, producing BGRA output."""
import cv2
import numpy as np
from nodes.opencv._utils import load_image_from_url, save_and_upload

metadata = {
    "display_name": "Apply Mask (Segment)",
    "description": "Apply grayscale mask to image to produce a BGRA result, with optional mask inversion.",
    "category": "segment",
    "color": "blue",
}
...
inputs = [
    ...
    {"var_name": "invert_mask", "display_name": "Invert Mask", "type": "boolean"},
]
...
async def execute(uid: str, token: str, inputs: dict) -> dict:
    ...
    invert_mask = bool(inputs.get("invert_mask", False))
